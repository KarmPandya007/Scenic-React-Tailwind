    ...
    return (
        <div className="footer flex flex-col justify-center items-center p-6 md:p-10 px-4 bg-gradient-to-b from-white via-emerald-50/50 to-white">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-30 max-w-6xl w-full">
                <motion.div
                    className="flex flex-col gap-4 text-center md:text-left animate-section-rise"
                ...
                <motion.div
                    className="flex flex-col gap-4 text-center md:text-left animate-section-rise animate-delay-1"
                    initial={reduceMotion ? undefined : { opacity: 0, y: 16 }}
                    animate={reduceMotion ? undefined : { opacity: 1, y: 0 }}
                ...
                <motion.div
                    className="flex flex-col gap-4 text-center md:text-left animate-section-rise animate-delay-2"
                    initial={reduceMotion ? undefined : { opacity: 0, y: 16 }}
                    animate={reduceMotion ? undefined : { opacity: 1, y: 0 }}
                ...
                >
                    ...
                    <motion.div
                        className="icons flex gap-6 mt-3 justify-center md:justify-start"
